...
class CounterpartyModel
{
    ...
    public static function save()
    {
        ...
        $counterparty->setPhone('+380661122331');
    ...
    {
        $counterparty = new Counterparty();
        $counterparty->setRef('b8ef2e70-d959-11ea-8513-b88303659df5');
        $counterparty->setCounterpartyProperty('Recipient');
        $counterparty->setCityRef('8d5a980d-391c-11dd-90d9-001a92567626');
        $counterparty->setCounterpartyType('PrivatePerson');
        $counterparty->setFirstName('Пили');
        $counterparty->setLastName('Пет');
        $counterparty->setMiddleName('Серг');
        $counterparty->setPhone('+380661122555');
