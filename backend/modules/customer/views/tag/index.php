...
$this->params['right_content'] .= Buttons::create('Добавить тег');
        ...
        [
            ...
            'buttons' => [
                'update' => function ($url, $model, $key) {
                    return Html::a('<i class="far fa-edit"></i>', ['/customer/tag/update', 'id' => $key],
                        [
                ...
                'delete' => function ($url, $model, $key) {
                    if ($model->id != CustomerTag::TAG_NEW) {
                        return Html::a('<i class="fas fa-trash-alt"></i>', ['/customer/tag/delete', 'id' => $key],
                            [
                                'title' => 'Удалить',
                                'class' => 'btn btn-outline-dark',
                                'data-method' => 'post',
