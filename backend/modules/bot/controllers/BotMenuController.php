...
use backend\modules\bot\models\search\BotMenuSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * BotMenuController implements the CRUD actions for BotMenu model.
 */
class BotMenuController extends Controller
{
    ...
    {
        if (($model = BotMenu::findOne($id)) !== null) {
            return $model;
        }
