...
<div class="row">
    <div class="col-md-12">
        <div class="bg">
            ...
            <?= $form->field($model, 'status')->dropDownList(ReviewSlider::statusesAll(), ['prompt' => 'Выбрать статус']) ?>
                ...
                <div class="row mt-4">
                    <div class="col-md-2">
                        <div class="main-img-block">
                            <?= Img::main(REVIEW_SLIDER, $model->id, $model->img, '400x400') ?>
                            <?php if ($model->img): ?>
                                <?= Img::deleteMainImg($model->id, REVIEW_SLIDER) ?>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="col-md-10">
