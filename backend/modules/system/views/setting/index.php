...
$this->params['right_content'] .= Buttons::create('Добавить настройку');
        ...
        [
            ...
            'buttons' => [
                'update' => function ($url, $model, $key) {
                    return Html::a('<i class="far fa-edit"></i>', ['/system/setting/update', 'id' => $key],
                        [
                ...
                'delete' => function ($url, $model, $key) {
                    if (Yii::$app->user->can('dev')) {
                        return Html::a('<i class="fas fa-trash-alt"></i>', ['/system/setting/delete', 'id' => $key],
                            [
                                'title' => 'Удалить',
                                'class' => 'btn btn-outline-dark',
                                'data-method' => 'post',
